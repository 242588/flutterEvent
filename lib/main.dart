...
import 'package:projetv1/views/auth/login_page.dart';
import 'package:projetv1/views/auth/register_page.dart';
import 'package:projetv1/views/organizer/create_event_page.dart';
import 'package:projetv1/views/organizer/home/event_list_page.dart';
import 'package:projetv1/views/user/welcome_page.dart';

void main() {
  runApp(const MyApp());
}

void testInsertAndFetch() async {
